...
//validating  input arguments
		if(args.length<2)
		{
			System.out.println("Java Usage :" +Driver.class.getName()+ " [config] /hdfs/path/to/input /hdfs/path/to/output");			
		}
		...
		try
		{
			...
			int i=ToolRunner.run(conf,(Tool) new Driver(),args);
	...
	public int run(String[] args) throws Exception
	{
		...
		Job wordCountJob = Job.getInstance(conf, Driver.class.getName());	
